...
project_name = "Employee Attrition & Performance"
project_link = "https://www.kaggle.com/datasets/pavansubhasht/ibm-hr-analytics-attrition-dataset?resource=download"

def get_introduction():
  #Use system prompt as a variable
  system_prompt = '''
  system_prompt = """
